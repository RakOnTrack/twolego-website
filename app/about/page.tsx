...
export const metadata: Metadata = {
  title: "About",
  description:
    "TwoLego has been North America's trusted SAP implementation partner since 1999. Learn about our history, team, and commitment to transforming business.",
};

const timeline = [
  { year: "1999", title: "Founded in Orange County", description: "TwoLego established as a SAP consulting firm, with a focus on North American mid-market businesses." },
  ...
  { year: "2012", title: "SAP Business One Specialization", description: "Became one of North America's leading SAP Business One implementers, serving 500+ SME customers." },
  ...
  { year: "2024", title: "6,000+ Customers", description: "Reached milestone of 6,000+ customers served across 70+ countries, cementing position as North America's most trusted SAP partner." },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <FadeUp>
            ...
            >
              We started TwoLego in Orange County in 1999 with a single belief: that SAP implementations succeed when the partner is as invested in your outcome as you are.
            </p>
          </FadeUp>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                With offices in Orange County and delivery capabilities across North America, Europe, and Asia-Pacific, we bring enterprise-grade expertise to businesses of every size — from 10-person startups to Fortune 500 multinationals.
              </p>
            </FadeUp>
                  ...
                  <div className="md:pl-16 relative">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: "var(--bg)",
                        boxShadow: "0 0 8px rgba(0,112,242,0.4)",
